...
**Total: 8 de 20 hallazgos formales corregidos (SAST-01, SAST-02, SAST-03, SAST-04, SAST-06, SAST-07, SAST-08, SAST-10), 2 mitigados parcialmente por decisión de alcance/infraestructura (SAST-05, SAST-09), 2 parcialmente mitigados por versión de dependencia (SCA-03/04).** El riesgo dominante que el reporte marcaba como bloqueante —BOLA en lecturas y escrituras de pacientes/médicos (SAST-01/SAST-02)— ya está remediado. Cada hallazgo corregido se verificó con pruebas aisladas de la lógica RBAC contra la base de datos real (sin efectos persistentes) y, cuando aplicó, con llamadas HTTP en vivo.
