...
def create_first_admin():
    ...
    try:
        ...
        email_admin = "jesus.hernandezh@imssbienestar.gob.mx"
        password_plana = "Eclipse215"
        ...
        nuevo_usuario = Usuario(
            nombre_usuario="Jesus Samuel",
            email=email_admin, # Usamos el correo definido arriba
            hashed_password=password_hasheada, # NUNCA guardamos la password_plana
